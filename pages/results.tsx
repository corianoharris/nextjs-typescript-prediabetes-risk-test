      ...
      <div className="relative bg-white px-2 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:min-w-lg sm:rounded-lg md:max-w-[60%] m-auto">
        <div className="mx-auto min-w-full tracking-wider">
          ...
          <div className="divide-y divide-gray-300/50">
            ...
            <p className="text-sm mt-2 text-indigo-600 font-medium bg-slate-200 p-2 rounded shadow-xl tracking-wider leading-7">If you African American, Hispanic/Latino American, American Indian/Alaska Native, or Pacific Islander, you are at a higher risk for prediabetes and type 2 diabetes. Also if you are Aisan American, you are at increased risk for type 2 diabetes at a lower weight (about 15 pounds lower than weight in first weight column). Talk to your doctor to see if you should have your blood sugar tested.</p>
            </div>
