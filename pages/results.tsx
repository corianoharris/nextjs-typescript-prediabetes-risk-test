    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-4 bg-slate-100">
      <div className="relative bg-white px-2 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:min-w-lg sm:rounded-lg md:max-w-[60%] m-auto">
        <div className="mx-auto min-w-full tracking-wider">
          <h1 className="text-xl text-center text-indigo-950 mb-5" role="heading" tabIndex={0} >{`Your score is `}<span className='mr-2 text-4xl text-indigo-500 underline underline-offset-4 font-black'>{`${score}`}</span><span>out of</span><span className='number-of-questions ml-2 text-3xl'>11</span></h1>
          <div className="divide-y divide-gray-300/50">
            <div className="space-y-6 text-base leading-7 text-indigo-300">
              {isloading && (
                <h3 className="text-md text-indigo-700 font-bold mb-2"  tabIndex={0} role="heading" >Calculating your results...</h3>
              )}
              {isLowRisk && (
                <div className="p-6 mb-2 text-indigo-300 leading-7 tracking-wider"  tabIndex={0}>
                  <h3 className="text-md text-indigo-700 font-bold mb-2" role="heading" >You are low risk for prediabetes.</h3>
              ...
              {isModerateRisk && (
                <div className="p-6 mb-2 text-indigo-300 leading-7 tracking-wider"  tabIndex={0} >
                  <h3 className="text-md text-indigo-700 mb-2 font-bold" role="heading" >You are moderate risk for prediabetes.</h3>
                  <p className="text-md text-indigo-500 font-medium bg-slate-200 p-2 rounded shadow-xl"  tabIndex={0}>Based on your score, there is a potential risk of developing prediabetes, but only your doctor can diagnose it for sure. Share your results with your doctor and ask for a simple blood test to confirm them.</p>
              ...
              {isHighRisk && (
                <div className="p-6 mb-2 text-indigo-300 leading-7 tracking-wider"  tabIndex={0}>
                  <h3 className="text-md text-indigo-700 mb-2 font-bold" role="heading">You are high risk for prediabetes.</h3>
            ...
            <div className=" p-3 text-base font-semibold leading-7 text-left "  tabIndex={0} >
